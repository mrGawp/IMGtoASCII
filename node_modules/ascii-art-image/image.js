(function (root, factory) {
    ...
    AsciiArt.Image.valueScales = {
        ...
        solid : '█'.split(''),
        numbers : '0123456789'.split('').reverse(),
        ...
        letters_LowerCase : 'abcegmnorsuvwxz'.split('').reverse(),
        letters_UpperCase : 'ABCEGMNORSUVWXZ'.split('').reverse(),
        letters_Both : 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'.split('').reverse(),
